...
/*----------------------------------------------------------------------------*
 *
 *  Name:  QuadDualPanSynth::initialize
 *
 *  Desc:  Initialize synth. 
 *
...
void QuadDualPanSynth::initialize() 
{ 
   super::initialize();
