 ...
 *        +vox[]            - ptrs to member voices
 *
 *  Note:  Derived classes which override initialize() must call this method from
 *         within their initialize() routine. 
 *
 *         This method:
 *
...
/*----------------------------------------------------------------------------*
 *
 *  Name:  TwoVoxPanSynth::initialize
 *
 *  Desc:  Initialize synth. 
 *
...
void TwoVoxPanSynth::initialize() 
{ 
   setupVoices(2);
